...
<template>
  <div class="min-h-screen bg-kawaii-cream">
    ...
    <!-- Mobile Sidebar (Vuetify Navigation Drawer) -->
    <v-navigation-drawer
      v-model="drawer"
      temporary
      location="left"
    ...
    <div class="flex min-h-screen">
      <!-- Sidebar -->
      <aside class="hidden lg:block w-72 bg-white  shadow-xl flex-shrink-0">
        <div class="p-6 relative overflow-hidden h-full">
          <!-- Animated Background Elements -->
          <div class="absolute inset-0 opacity-20">
            <div class="absolute top-0 left-0 w-32 h-32 bg-white rounded-full blur-xl animate-pulse"></div>
      ...
      <main class="flex-1 flex flex-col min-w-0">
          ...
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
              ...
              <div class="flex items-center space-x-4">
                ...
                <button
                  @click="drawer = !drawer"
                  class="lg:hidden flex items-center space-x-2 bg-white rounded-full p-2 shadow-md hover:shadow-lg transition-all duration-300 border border-kawaii-pink-light"
                >
        ...
        <!-- Content -->
        <div class="flex-1 bg-kawaii-cream">
